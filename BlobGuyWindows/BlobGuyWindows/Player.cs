...
namespace punchaface
{
    public class Player : Sprite
    {
        ...
        public static int LevelNumber; //why you static?, Only one instance of the level number is ever needed
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (OnPlatform(gameTime))
            {
                ...
                if (keys.IsKeyDown(Keys.W))
                {
                    ...
                    //if (keys.IsKeyDown(Keys.W) && Player.LevelNumber >= 9 && Player.LevelNumber <= 15)
                      //  velocity.Y = -18f;
        ...
        private bool OnPlatform(GameTime gameTime)
        {
            ...
            foreach (Sprite gameElement in GameScreen.ActiveGame.GameObjects)
            {
                ...
                if (playerRect.Intersects(gameElement.GetRect))
                {
                    ...
                    else if (gameElement is Powerup)
                    {
            ...
            if (onPlatform)//touching anything
            {
